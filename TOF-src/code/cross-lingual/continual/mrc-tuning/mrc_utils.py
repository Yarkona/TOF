    ...
    for (example_idx, example) in enumerate(examples):
        ...
        if len(example.start_position) == 0 and len(example.end_position) == 0:
            ...
            for start_item in example.start_position:
                ...
                try:
                    ...
                    # print(example_idx)
                    # print(example.context_item.encode("utf-8"))
                    # print(whitespace_doc)
                    # print(example.span_position)
                    # print(end_item)
                    valid = False
                    break
        ...
        features.append(
            InputFeatures(
                ...
                ner_cate=label_map[example.ner_cate] if example.ner_cate is not None else label_map["OTHER"]
                ))
