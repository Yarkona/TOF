...
class DataProcessor(object):
    ...
    def get_sep_scitech_dev_examples(self, data_dir):
        return self._create_examples(
            self._read_pkl(os.path.join(data_dir, "sep_scitech_dev.pkl")), "twitter_dev")
...
def main():
    ...
    if args.do_train:
        ...
        total_examples = processor.get_sep_scitech_train_examples(args.data_dir)
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
                ...
                eval_examples = processor.get_sep_scitech_dev_examples(args.data_dir)
